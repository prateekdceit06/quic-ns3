    ...
    static TypeId tid =
        TypeId("ns3::QuicSocketBase")
            ...
            .AddAttribute("MaxStreamIdBidi",
                          ...
                          UintegerValue(2), // according to the QUIC RFC this value should default
